...
**Do:**
> If your BIG-IP doesn't respond, restore the UCS file.

**Don't:**
> If the changes are not operating as expected, you may return the
> environment to its starting point by restoring the backup UCS file.
