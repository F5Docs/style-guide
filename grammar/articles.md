...
title: Articles
category: grammar
aliases: [articles, a, an, the, definite, indefinite]
applies-to: [all F5 docs]
source-authority: F5 Modern Voice, Microsoft Style Guide
supersedes:
...
**Don't:**
> In **Tunnel Location** section, select destination location.

> BIG-IP system receives all inbound traffic.
