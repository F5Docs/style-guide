...
aliases: [color, contrast, color blindness, high contrast, patterns]
applies-to: [all F5 docs]
source-authority: Microsoft Style Guide
supersedes:
...
**Do:**
> Use both color and underlined text for links.

> Use both color and pattern to differentiate data series in charts
> and graphs.

**Don't:**
> Use a red label alone to indicate an error state.

> Use color alone to distinguish lines in a chart.
