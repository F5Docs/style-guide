...
Use tables to present comparative or structured information that has a
clear relationship between rows and columns. Keep table content concise.
...
**Don't:**
> Use a table to present a simple list that would read
> naturally as prose or bullets.
...
Use parallel structure within columns — each cell in a column should
