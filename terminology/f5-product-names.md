...
3. **Subsequent mention, not listed:** If the table doesn't list a subsequent mention, repeat the full first-mention name. Don't invent a shortened form.
...
> The BIG-IP system configuration is backed up automatically.
...
| F5 Centos | -- | -- |
| F5 CGNAT for BIG-IP | -- | F5 BIG-IP CGNAT |
...
| F5 PEM for BIG-IP | -- | F5 BIG-IP PEM |
...
| F5 VELOS | -- | -- |
| F5 VIPRION | -- | -- |
| F5 WAF for BIG-IP | -- | F5 BIG-IP Advanced WAF |
| F5 WAF for Envoy | -- | -- |
