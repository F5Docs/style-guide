...
aliases: [possessives, apostrophe, ownership, product names]
...
**Do:**
> The BIG-IP system configuration file is located at /config/.

> The NGINX Agent REST API supports the following endpoints.

> F5's approach to security is built on zero trust principles.

**Don't:**
> BIG-IP's configuration file is located at /config/.

> NGINX Agent's REST API supports the following endpoints.

> The BIG-IP's tendency to cache responses can be configured.

## Notes

Never use possessive form with trademarked product names:
