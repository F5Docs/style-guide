...
{Include this section only when users must take action before, during, or after upgrading. Describe the required action as a direct instruction or numbered steps. Link to the full upgrade guide if one exists. Omit this section entirely if no user action is required.}

---

### What's new

{Include this section only when the release contains new features or enhancements. Omit if there are none.}
...
{Include this section only when the release fixes reported issues. Omit if there are none.}
