...
See the [`copilot-instructions.md`](https://github.com/nginx/documentation/blob/main/.github/copilot-instructions.md) file in the [nginx/documentation](https://github.com/nginx/documentation) repository for a working example of how to configure this.
